...
<div class="wrapper tabs">
    <div class="tab-content" id="tab1">
        ...
        <div class="wrapper pad_bot2">
            <figure class="left marg_right1"><?php echo img("asset/templates/user/images/page2_img1.jpg"); ?></figure>
        ...
        <div class="wrapper pad_bot2">
            <figure class="left marg_right1"><?php echo img("asset/templates/user/images/page2_img2.jpg"); ?></figure>
        ...
        <div class="wrapper pad_bot2">
            <figure class="left marg_right1"><img src="<?php echo base_url(); ?>asset/templates/user/images/page2_img3.jpg" alt=""></figure>
